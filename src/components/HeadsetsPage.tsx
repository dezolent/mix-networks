...
function HeadsetsPage() {
  ...
  const ProductCard = ({ product }: { product: HardwareProduct }) => (
    <a
      ...
      className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group border-2 border-gray-100 hover:border-[#5fa68f]"
    >
      <div className="relative h-48 overflow-hidden bg-gradient-to-br from-[#3d8eb3]/10 to-[#5fa68f]/10">
        {product.image_url ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            <Headphones className="w-20 h-20 text-[#5fa68f]/30" />
          </div>
        )}
        <div className="absolute top-3 right-3 bg-[#5fa68f] text-white p-2 rounded-full shadow-lg group-hover:scale-110 transition-transform">
      ...
      <div className="p-6">
        <div className="flex items-center gap-2 mb-2">
          {product.make && (
            <span className="text-sm font-semibold text-[#5fa68f]">{product.make}</span>
          )}
          {product.model && (
            <span className="text-sm text-gray-500">• {product.model}</span>
          )}
        </div>
        <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#5fa68f] transition-colors">
          {product.title}
        </h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-br from-[#3d8eb3] to-[#5fa68f]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center text-white">
            <div className="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-6 border border-white/30 backdrop-blur-sm">
              ...
              <span className="text-sm font-semibold">HEADSETS</span>
            </div>
            ...
            <p className="text-xl lg:text-2xl mb-8 text-white/95 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
              Crystal-clear audio quality for call centers, offices, and remote work environments
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <p className="text-gray-600 text-center max-w-2xl mx-auto">
              Our professional headset solutions deliver exceptional audio quality, all-day comfort, and reliable connectivity for business communication needs.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#3d8eb3] to-[#5fa68f]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Enhance Your Team's Communication with Professional Headsets
          </h2>
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Improve call quality and productivity with wireless DECT headsets from Yealink. Perfect for call centers, remote teams, and office environments. Get expert recommendations for your business needs.
          </p>
