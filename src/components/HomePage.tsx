        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => {
              const serviceColors = [
                { bg: 'from-[#3d8eb3] to-[#2c7a9e]', icon: '[#3d8eb3]', hover: 'hover:border-[#3d8eb3]' },
                { bg: 'from-[#b0d136] to-[#8fb52a]', icon: '[#b0d136]', hover: 'hover:border-[#b0d136]' },
                { bg: 'from-[#5c5d5d] to-[#4a4b4b]', icon: '[#5c5d5d]', hover: 'hover:border-[#5c5d5d]' },
                { bg: 'from-[#3d8eb3] to-[#5fa68f]', icon: '[#3d8eb3]', hover: 'hover:border-[#3d8eb3]' },
              ];
              ...
              return (
                <div
                  key={index}
                  className={`group bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 ${color.hover} hover:scale-105`}
                >
                  <div className="mb-6">
                    <div className={`w-16 h-16 bg-gradient-to-br ${color.bg} rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300`}>
                      {service.icon}
                    </div>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    {service.features.map((feature, idx) => (
                      <div key={idx} className="flex items-start space-x-3">
                        <div className={`w-5 h-5 bg-gradient-to-br ${color.bg} rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5`}>
                  ...
                  <button className={`group/btn w-full bg-gradient-to-r ${color.bg} text-white px-6 py-3 rounded-xl hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-2 font-semibold transform hover:scale-105`}>
