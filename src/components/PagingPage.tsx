...
function PagingPage() {
  ...
  const ProductCard = ({ product }: { product: HardwareProduct }) => (
    ...
    >
      <div className="relative h-48 overflow-hidden bg-gradient-to-br from-[#5fa68f]/10 to-[#b0d136]/10">
        {product.image_url ? (
          <img
          ...
          <div className="w-full h-full flex items-center justify-center">
            <Volume2 className="w-20 h-20 text-[#5fa68f]/30" />
          </div>
        )}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-br from-[#5fa68f] to-[#b0d136]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center text-white">
            <div className="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-6 border border-white/30 backdrop-blur-sm">
              ...
              <span className="text-sm font-semibold">PAGING SYSTEMS</span>
            </div>

            <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              <span className="text-white drop-shadow-lg">IP-Based</span>
            ...
            <p className="text-xl lg:text-2xl mb-8 text-white/95 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
              Modern paging systems for schools, warehouses, hospitals, and large facilities
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <p className="text-gray-600 text-center max-w-2xl mx-auto">
              Our IP paging solutions integrate seamlessly with modern VoIP systems, providing clear audio announcements across your entire facility with centralized management.
            </p>
          </div>
